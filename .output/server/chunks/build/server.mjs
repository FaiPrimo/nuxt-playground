...
import { $ as $fetch, l as defu, m as sanitizeStatusCode, n as createHooks, h as createError$1, t as toRouteMatcher, o as createRouter, p as getRequestHeaders, q as klona, r as parse$1, v as getRequestHeader, w as destr, x as isEqual$1, y as setCookie, z as getCookie, A as deleteCookie } from '../runtime.mjs';
...
const _routes = [
  {
    name: "events",
    path: "/events",
    component: () => import('./events-DKo-zBYP.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BrsA4ZOn.mjs')
  }
];
...
function isChangingPage(to, from) {
  if (to === from || from === vueRouter_cjs.START_LOCATION) {
    return false;
  }
...
const plugin = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    const history = ((_a = routerOptions.history) == null ? void 0 : _a.call(routerOptions, routerBase)) ?? vueRouter_cjs.createMemoryHistory(routerBase);
    const routes = routerOptions.routes ? ([__temp, __restore] = executeAsync(() => routerOptions.routes(_routes)), __temp = await __temp, __restore(), __temp) ?? _routes : _routes;
    let startPosition;
    const router = vueRouter_cjs.createRouter({
      ...routerOptions,
      scrollBehavior: (to, from, savedPosition) => {
        if (from === vueRouter_cjs.START_LOCATION) {
        ...
        if (routerOptions.scrollBehavior) {
          ...
          return routerOptions.scrollBehavior(to, vueRouter_cjs.START_LOCATION, startPosition || savedPosition);
        }
      },
      history,
      routes
...
const localeLoaders = {
  "en": [{ key: "../src/locales/en.json", load: () => import(
    './en-C-GBc85q.mjs'
    /* webpackChunkName: "locale__Users_primo_Desktop_Workspaces_playground_nuxt_playground_src_locales_en_json" */
  ), cache: true }],
  "th": [{ key: "../src/locales/th.json", load: () => import(
    './th-BDnmVYwT.mjs'
    /* webpackChunkName: "locale__Users_primo_Desktop_Workspaces_playground_nuxt_playground_src_locales_th_json" */
  ), cache: true }]
};
...
const __nuxt_component_0 = defineComponent({
  ...
  setup(props, context) {
    ...
    const route = injectedRoute === useRoute() ? vueRouter_cjs.useRoute() : injectedRoute;
...
const __nuxt_component_1 = defineComponent({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      return h(vueRouter_cjs.RouterView, { name: props.name, route: props.route, ...attrs }, {
        default: (routeProps) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CVaGaRWq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BLfAgwc9.mjs'));
...
export { _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, withoutTrailingSlash as d, entry$1 as default, resolveUnrefHeadInput as e, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseQuery as p, resolveRouteObject as r, useRouter as u, withTrailingSlash as w };
